...
import type { Stakeholder, LinkedInExperience, LinkedInEducation } from "@/lib/types";
...
const stakeholderSchema = z.object({
  ...
  datos_especificos_linkedin: z.object({
    ...
    experiencia: z.array(linkedInExperienceSchema).optional(),
    formacion: z.array(linkedInEducationSchema).optional(),
                        ...
                        <Card key={field.id} className="p-4">
                          <div className="space-y-4">
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormControl>
                                      <Input {...field} placeholder="Nombre del título" />
                                    </FormControl>
                                    <FormMessage />
                                  </FormItem>
                                )}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <FormField
                                control={form.control}
                                name={`datos_especificos_linkedin.formacion.${index}.año_inicio`}
                                render={({ field }) => (
                                  <FormItem>
                              ...
                              <FormField
                                control={form.control}
                                name={`datos_especificos_linkedin.formacion.${index}.año_fin`}
                                render={({ field }) => (
                                  <FormItem>
